...
# Fix app icons using ImageMagick to properly remove alpha channel
echo "🔧 Fixing app icons with ImageMagick..."
...
create_icon() {
    ...
    convert "$LOGO" -resize ${size}x${size} -background white -alpha remove "$OUTPUT_DIR/$filename"
}
