  ...
  List<Notam> _createDemoNotams() {
    ...
    return [
      ...
      Notam(
        ...
        fieldD: '',
        fieldE: 'Runway 06/24 closed for maintenance',
        fieldF: '',
        fieldG: '',
        qCode: 'QMRLC',
        isCritical: true,
      ...
      Notam(
        ...
        fieldD: '',
        fieldE: 'Taxiway A partially closed',
        fieldF: '',
        fieldG: '',
        qCode: 'QMXLC',
        isCritical: false,
      ...
      Notam(
        ...
        fieldD: '',
        fieldE: 'ILS runway 06 unserviceable',
        fieldF: '',
        fieldG: '',
        qCode: 'QICLC',
        isCritical: true,
      ...
      Notam(
        ...
        fieldD: '',
        fieldE: 'Runway lighting unserviceable',
        fieldF: '',
        fieldG: '',
        qCode: 'QLCLC',
        isCritical: false,
      ...
      Notam(
        ...
        fieldD: '',
        fieldE: 'Bird hazard reported in vicinity',
        fieldF: '',
        fieldG: '',
        qCode: '',
        isCritical: true,
      ...
      Notam(
        ...
        fieldD: '',
        fieldE: 'Airport fuel services limited',
        fieldF: '',
        fieldG: '',
        qCode: 'QFAFC',
        isCritical: false,
      ...
      Notam(
        ...
        fieldD: '',
        fieldE: 'New arrival procedure implemented',
        fieldF: '',
        fieldG: '',
        qCode: 'QPAFC',
        isCritical: false,
      ...
      Notam(
        ...
        fieldD: '',
        fieldE: 'Temporary restricted area active',
        fieldF: '',
        fieldG: '',
        qCode: 'QRAFC',
        isCritical: true,
      ...
      Notam(
        ...
        fieldD: '',
        fieldE: 'General information notice',
        fieldF: '',
        fieldG: '',
        qCode: '',
        isCritical: false,
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text('Raw Text:'),
            Text(notam.rawText, style: const TextStyle(fontSize: 12)),
            const SizedBox(height: 8),
            Text('Field E (Main Content):'),
            Text(notam.fieldE, style: const TextStyle(fontSize: 12)),
            if (notam.fieldF.isNotEmpty || notam.fieldG.isNotEmpty) ...[
              const SizedBox(height: 8),
              Text('Altitude Info (Fields F & G):'),
              Text('${notam.fieldF} TO ${notam.fieldG}', style: const TextStyle(fontSize: 12)),
            ],
          ],
        ),
        actions: [
